...
export const Header = () => {
    return (
        <header className="h-20 w-full border-b-2 border-slate-200 px-4 bg-green-200">
            <div className="flex items-center justify-between mx-auto h-full lg:max-w-screen-xl">
